...
//
// 【MP3 檔案命名規則】
// 格式：s{string}_f{fret}.mp3
// 例如：
//   s1_f0.mp3  = 第 1 弦第 0 格（第 1 弦空弦，高音 E）
//   s1_f5.mp3  = 第 1 弦第 5 格（A 音）
//   s6_f0.mp3  = 第 6 弦第 0 格（第 6 弦空弦，低音 E）
//
// 【如果 MP3 不存在】
...
class SoundManager(private val context: Context) {
     ...
     * 播放指定的音檔
     * 
     * @param resourceName 資源名稱，例如 "s1_f5" 代表 s1_f5.mp3
     * 
     * 步驟：
    ...
    fun play(resourceName: String) {
        try {
            // 步驟 1: 查找資源 ID
            // context.resources.getIdentifier() 會在 res/raw/ 目錄中找 resourceName.mp3
